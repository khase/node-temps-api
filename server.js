...
const generalSQL = "SELECT DATE_FORMAT(FROM_UNIXTIME(`" + tableNameData + "`.timestamp), \"%Y.%m.%d %H:00\") as date, `" + tableNameTypes + "`.name, `" + tableNameData + "`.value, `" + tableNameTypes + "`.unit FROM (SELECT MIN(timestamp) as timestamp, type, ROUND(AVG(value), 2) as value FROM `" + dbName + "`.`" + tableNameData + "` WHERE `" + dbName + "`.`" + tableNameData + "`.timestamp < UNIX_TIMESTAMP() AND `" + dbName + "`.`" + tableNameData + "`.timestamp > 1500000000 GROUP BY `" + dbName + "`.`" + tableNameData + "`.timestamp div 3600, `" + dbName + "`.`" + tableNameData + "`.type) AS `" + tableNameData + "` JOIN `" + dbName + "`.`" + tableNameTypes + "` ON `" + dbName + "`.`" + tableNameTypes + "`.id = `" + tableNameData + "`.type ORDER BY `" + tableNameData + "`.timestamp desc ";
const todaySQL = "SELECT DATE_FORMAT(FROM_UNIXTIME(`" + tableNameData + "`.timestamp), \"%Y.%m.%d %H:%i\") as date, `" + tableNameTypes + "`.name, `" + tableNameData + "`.value, `" + tableNameTypes + "`.unit FROM (SELECT MIN(timestamp) as timestamp, type, ROUND(AVG(value), 2) as value FROM `" + dbName + "`.`" + tableNameData + "` WHERE `" + dbName + "`.`" + tableNameData + "`.timestamp < UNIX_TIMESTAMP() AND `" + dbName + "`.`" + tableNameData + "`.timestamp > UNIX_TIMESTAMP() - time_to_sec(NOW()) GROUP BY `" + dbName + "`.`" + tableNameData + "`.timestamp div 900, `" + dbName + "`.`" + tableNameData + "`.type) AS `" + tableNameData + "` JOIN `" + dbName + "`.`" + tableNameTypes + "` ON `" + dbName + "`.`" + tableNameTypes + "`.id = `" + tableNameData + "`.type ORDER BY `" + tableNameData + "`.timestamp desc";
